...
public class C04_StaleElementReferanceException extends TestBase {
    ...
    public void StaleElementReferanceExceptionTest4() {
      ...
      //  bekle(2);
       ...
       //s Assert.assertTrue(login.isDisplayed());//org.openqa.selenium.StaleElementReferenceException:
    ...
    public void StaleElementReferanceExceptionTest5() {
        ...
        //iphone aratalım
        driver.findElement(By.id("twotabsearctextbox")).sendKeys("iphone");
        ...
        for (int i = 0; i < urunler.size(); i++) {
            ...
            //bunda hata aldim cunku List icindeki webelemnti for disinda kaldigi icin bulamadi
            //simdi asagida dogrusunu yapicaz
            driver.get("https://amazon");
            driver.findElement(By.id("twotabsearctextbox")).sendKeys("iphone");
            List<WebElement> urunler1 = driver.findElements(By.xpath("//h2"));
            for (int i = 0; i < urunler1.size(); i++) {
                urunler1.get(i).click();
                bekle(3);
                driver.navigate().back();
                bekle(3);
                if (i == 4) {
                ...
                urunler1 = driver.findElements(By.xpath("//h2"));
            }
