...
public class C01_MavenilkTest {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("(//*[@class='a-link-normal s-underline-text s-underline-link-text s-link-style a-text-normal'])[1] "))
                .click();


        //sayfadaki tum basliklari yazdiriniz
